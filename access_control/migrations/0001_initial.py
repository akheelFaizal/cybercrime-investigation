    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('CITIZEN', 'Citizen'), ('ORGANIZATION', 'Organization'), ('ADMIN', 'Administrator'), ('OFFICER', 'Law Enforcement Officer')], default='CITIZEN', max_length=20)),
